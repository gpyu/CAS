...
<t:datagrid name="userList" title="common.operation" actionUrl="kqUserController.do?datagridStudent" fit="true" fitColumns="true" idField="id" queryMode="group" sortName="createDate,userName" sortOrder="asc,desc">
