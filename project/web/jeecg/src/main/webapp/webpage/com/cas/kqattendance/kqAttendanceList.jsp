...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="kqAttendanceList" title="考勤管理" actionUrl="kqAttendanceController.do?datagrid" idField="id" fit="true">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="学生id" field="studentId"   width="120"></t:dgCol>
   <t:dgCol title="课程id" field="courseId"   width="120"></t:dgCol>
   <t:dgCol title="类型：出勤、缺勤、迟到、请假" field="type"   width="120"></t:dgCol>
