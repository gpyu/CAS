...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="kqCourseInfoList" title="课程名称维护" actionUrl="kqCourseInfoController.do?datagrid" idField="id" fit="true">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
    <t:dgCol title="课程名称" field="courseName"   width="120"></t:dgCol>
   <t:dgCol title="课时" field="courseClassHour"   width="120"></t:dgCol>
