package com.cas.controller.kquser;
...
//@Scope("prototype")
@Controller
@RequestMapping("/kqUserController")
public class KqUserController extends BaseController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(KqUserController.class);
	...
	public String student(HttpServletRequest request) {
		...
		departList.clear();
		return "com/cas/kqstudent/kqstudentList";
	}
	...
	public String teacher(HttpServletRequest request) {
		...
		request.setAttribute("departsReplace", RoletoJson.listToReplaceStr(departList, "departname", "id"));
		departList.clear();
		return "com/cas/kqteacher/teacherList";
	}
	 ...
	 * @param dataGrid
	 */
	@RequestMapping(params = "datagridStudent")
	public void datagridStudent(TSUser user,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
...
//		update-end--Author:gaofeng Date:20140822 for：添加用户的角色展示
	...
	public void datagridTeacher(TSUser user,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		CriteriaQuery cq = new CriteriaQuery(TSUser.class, dataGrid);
        //查询条件组装器
        org.jeecgframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, user);
